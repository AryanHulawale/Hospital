...
import { Mail, Lock, Badge, PersonStanding, PersonStandingIcon } from 'lucide-react';
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-2.5">
                                ...
                                <div className="flex flex-col gap-1 flex-1">
                                    ...
                                    <div className="relative">
                                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[18px]">
                                            <Mail className="absolute top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                                        </span>
                                        <input
                            ...
                            <div className="flex flex-col md:flex-row gap-2.5">
                                <div className="flex flex-col gap-1 flex-1">
                                    ...
                                    <div className="relative">
                                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[18px]">
                                            <Lock className="absolute top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                                        </span>
                                        <input
                                ...
                                <div className="flex flex-col gap-1 flex-1">
                                    ...
                                    <div className="relative">
                                        <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-[18px]">
                                            <Lock className="absolute  top-1/2 -translate-y-1/2 text-slate-400" size={18} /></span>
                                        <input
                                            className="w-full pl-10 pr-9 py-2 rounded-lg border border-[#dae2e7] dark:border-[#3a4b55] bg-white dark:bg-[#0f1c23] text-sm"
