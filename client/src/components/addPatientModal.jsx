...
import { addPatient } from '../axios/api';

const AddPatientModal = ({ onClose, refresh }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Error adding patient profile.");
    }
  };
      ...
      <div className="bg-white w-full max-w-lg rounded-xl shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-base font-bold text-[#101618]">New Patient Entry</h2>
              <p className="text-[10px] text-slate-500 font-medium tracking-tight">Create a new clinical medical profile</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 flex flex-col gap-1">
              ...
              <input 
                ...
                className="w-full h-10 px-3 rounded-lg border border-slate-200 bg-slate-50 text-sm focus:ring-2 focus:ring-[#0284c5]/20 focus:border-[#0284c5] outline-none"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input 
                type="text" required placeholder="+1 000 000 000"
                className="w-full h-10 px-3 rounded-lg border border-slate-200 bg-slate-50 text-sm focus:ring-2 focus:ring-[#0284c5]/20 focus:border-[#0284c5] outline-none"
          ...
          <div className="flex flex-col gap-1">
            ...
            <input 
              required placeholder="Street, City, State"
              className="w-full h-10 px-3 rounded-lg border border-slate-200 bg-slate-50 text-sm focus:ring-2 focus:ring-[#0284c5]/20 focus:border-[#0284c5] outline-none"
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea 
              placeholder="Known allergies, previous surgeries, or medications..."
              className="w-full h-20 p-3 rounded-lg border border-slate-200 bg-slate-50 text-sm focus:ring-2 focus:ring-[#0284c5]/20 focus:border-[#0284c5] outline-none resize-none"
